...
BEGIN
    CREATE TABLE [Baskets] (
		...
		CONSTRAINT [FK_Baskets_StorageLocations_StorageLocationId] FOREIGN KEY ([StorageLocationId]) REFERENCES [StorageLocations] ([StorageLocationId])
    );
END
GO
...
BEGIN
    CREATE TABLE [Supplies] (
		...
		[StorageLocationId] uniqueidentifier NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000',
		...
		CONSTRAINT [FK_Supplies_StorageLocations_StorageLocationId] FOREIGN KEY ([StorageLocationId]) REFERENCES [StorageLocations] ([StorageLocationId]) ON DELETE CASCADE,
        CONSTRAINT [FK_Supplies_Donors_DonorId] FOREIGN KEY ([DonorId]) REFERENCES [Donors] ([DonorId])
    );
END
GO
...
BEGIN
    CREATE TABLE [BasketTransactions] (
        ...
        [DistributedBy] nvarchar(max) NOT NULL,
        [LastUpdateId] nvarchar(max) NULL,
        [LastUpdateDateTime] datetime2 NOT NULL,
        [DonorId] uniqueidentifier NULL,
...
IF NOT EXISTS (SELECT 1 FROM [StorageLocations])
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'StorageLocationId', N'Name', N'Shelf', N'Row', N'Column', N'LastUpdateDateTime', N'LastUpdateId') AND [object_id] = OBJECT_ID(N'[StorageLocations]'))
        SET IDENTITY_INSERT [StorageLocations] ON;
    INSERT INTO [StorageLocations] ([StorageLocationId], [Name], [Shelf], [Row], [Column], [LastUpdateDateTime], [LastUpdateId])
    VALUES ('1CAE190D-DD77-4499-88CF-54C343A67B9F', N'Infant/Toddler Room', NULL, NULL, NULL, '2023-11-27T15:38:38.4889140-06:00', N'travis@mailsac.com'),
    ('D909F9EA-5E6F-4564-AF2D-5CF641D8CAFF', N'Teen Room', NULL, NULL, NULL, '2023-11-27T15:38:38.4889140-06:00', N'travis@mailsac.com'),
	('6D65B8A5-4F27-46CB-8B0B-7CC1C83F7F53', N'School Age Room', NULL, NULL, NULL, '2023-11-27T15:38:38.4889140-06:00', N'travis@mailsac.com');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'StorageLocationId', N'Name', N'Shelf', N'Row', N'Column', N'LastUpdateDateTime', N'LastUpdateId') AND [object_id] = OBJECT_ID(N'[StorageLocations]'))
...
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'SupplyId', N'Barcode', N'CategoryId', N'Description', N'ExcludeCategoryId', N'ExpirationDate', N'Expires', N'LastUpdateDateTime', N'LastUpdateId', N'Name', N'OptionalCategoryId', N'Price', N'PurchaseDate', N'Quantity', N'StorageLocationId', N'Active', N'BasketId') AND [object_id] = OBJECT_ID(N'[Supplies]'))
        SET IDENTITY_INSERT [Supplies] ON;
    INSERT INTO [Supplies] ([SupplyId], [Barcode], [CategoryId], [Description], [ExcludeCategoryId], [ExpirationDate], [Expires], [LastUpdateDateTime], [LastUpdateId], [Name], [OptionalCategoryId], [Price], [PurchaseDate], [Quantity], [StorageLocationId], [Active], [BasketId])
    VALUES ('06f703f4-dfbf-4fd0-b0a6-5c75bc8fe17a', NULL, '2fb04be4-3b23-42eb-9534-20d767654667', N'Koala baby girls'' newborn blanket sleeper, 2 pack, take me home sleep n play pajamas (Newborn-6M)', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889740-06:00', N'travis@mailsac.com', N'Koala Baby Footed Sleeper (girl, 2 pk, NB-6M)', NULL, 10.58, '2023-11-27T15:38:38.4889740-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit), NULL),
    ('07979a90-bab9-47cf-befd-f0b16999ee00', NULL, 'f27211ee-28cb-42a1-b487-51aa7456ccd3', N'Gerber baby boy and girl unisex terry bootie wiggle-proof socks, 4-pack, newborn, 0-6 months.', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889820-06:00', N'travis@mailsac.com', N'Baby socks (unisex, 4 pk, newborn, 0-6 months)', NULL, 4.0, '2023-11-27T15:38:38.4889820-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit), NULL),
    ('16f0b155-8127-4eab-99e1-65473bc89952', NULL, '61da1441-6b0e-4d1a-88a2-ec632d01906d', N'Johnson''s head-to-toe gentle baby wash & shampoo, tear-free, sulfate-free & hypoallergenic wash for baby''s sensitive skin & hair, 27.1 fl. oz.', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889750-06:00', N'travis@mailsac.com', N'Gentle Baby Wash & Shampoo (tear-free, sulfate-free, hypoallergenic, 27.1 fl oz)', NULL, 11.95, '2023-11-27T15:38:38.4889750-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit), NULL),
    ('1ec27cd4-58a3-49d3-8395-8d83536a4305', NULL, 'bf225467-4b08-4da0-a1e5-2ef0ff6e2f96', N'Desitin maximum strength baby diaper rash cream with zinc oxide, 4 oz', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889760-06:00', N'travis@mailsac.com', N'Desitin Diaper Cream (4 oz)', NULL, 7.78, '2023-11-27T15:38:38.4889750-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit), NULL),
    ('331d83d3-04e4-41ca-9527-8ebcc1316090', NULL, 'd07d2c78-acbb-4d73-806d-1b5c67914554', N'Pampers sensitive baby wipes, 8 flip-top packs, 672 wipes', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889800-06:00', N'travis@mailsac.com', N'Pampers Baby Wipes (sensitive, 8 pk, 672 wipes)', NULL, 23.47, '2023-11-27T15:38:38.4889800-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit), NULL),
    ('3a13f50b-b57f-44ae-ba14-f65e4e27cd54', NULL, 'ec00957f-aa3b-4c34-8554-aa2aaf10335f', N'Pampers baby-dry leakproof day & night diapers, size 2 (12-18 lb), 37 count, unisex.', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889830-06:00', N'travis@mailsac.com', N'Pampers Baby Dry Diapers Size 2 (12-18 lb), 37 Count', NULL, 9.97, '2023-11-27T15:38:38.4889820-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit), NULL),
    ('3e2d5eee-ebfc-4a86-9c9c-18049eccaeed', NULL, 'd11d87e7-126c-4a3c-8125-b6a656d64fcc', N'NUK newborn orthodontic pacifiers, girl, 0-2 months, 2-pack.', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889720-06:00', N'travis@mailsac.com', N'Orthodontic Pacifiers (2 pk, girl, 0-2 month)', NULL, 6.77, '2023-11-27T15:38:38.4889720-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit), NULL),
    ('5aa553c8-f564-4755-9d2a-8e5a66f884d1', NULL, 'cdfc6b7f-31fb-4bd1-a246-6b8efc241dff', N'Aveeno baby daily moisture body lotion for sensitive skin with natural colloidal oatmeal, suitable  for newborns, 18 FL oz', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889790-06:00', N'travis@mailsac.com', N'Aveeno Baby Daily Moisture Body Lotion (sensitive skin, 18 FL oz)', NULL, 11.38, '2023-11-27T15:38:38.4889790-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit), NULL),
    ('6d59f00f-d7d8-48e3-ab36-9d96de8b09d0', NULL, '7ac8c99f-aaca-4883-ab1f-fb94fbaa9fca', N'NUK smooth flow pro anti-colic baby bottle, 5 oz, blue, 3-pack', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889800-06:00', N'travis@mailsac.com', N'Anti-colic Baby Bottles (blue, 3 pk, 5 oz)', NULL, 14.97, '2023-11-27T15:38:38.4889800-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit), NULL),
    ('7604aea7-96b0-4096-8bbb-bbef00fdc221', NULL, 'ec00957f-aa3b-4c34-8554-aa2aaf10335f', N'Pampers swaddlers diapers, newborn (< 10 lb), 31 count, unisex', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889810-06:00', N'travis@mailsac.com', N'Pampers Diapers (NB, 31 count)', NULL, 14.5, '2023-11-27T15:38:38.4889810-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit), NULL),
...
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'BasketId', N'AgeGroupId', N'EthnicityId', N'GenderId', N'DateAssembled', N'Quantity', N'SafeStockLevel', N'LastUpdateDateTime', N'LastUpdateId', N'IsShoppingListItem', N'BasketNumber', N'StorageLocationId', N'Active') AND [object_id] = OBJECT_ID(N'[Baskets]'))
        SET IDENTITY_INSERT [Baskets] ON;
    INSERT INTO [Baskets] ([BasketId], [AgeGroupId], [EthnicityId], [GenderId], [DateAssembled], [Quantity], [SafeStockLevel], [LastUpdateDateTime], [LastUpdateId], [IsShoppingListItem], [BasketNumber], [StorageLocationId], [Active]) 
    VALUES (N'542e0839-1b15-4336-a832-16fa88578c33', N'e7581e8f-e2ac-4550-aac7-d4ff7fe778e1', N'0040e5c2-0d7f-4db8-a7e8-28c5efa6cf4f', N'78cc56f2-717b-45cb-b025-09c0cca68f27', CAST(N'2023-11-10T00:00:00.0000000' AS DateTime2), 0, 5, CAST(N'2023-11-20T11:57:37.3760162' AS DateTime2), N'travis@mailsac.com', CAST(1 AS bit), 2, NULL, CAST(1 AS bit)),
    (N'7e50139d-1674-4bc5-9945-2841d9e50d7a', N'ed2da6d8-a312-489d-b7d0-253d75c6c820', N'0040e5c2-0d7f-4db8-a7e8-28c5efa6cf4f', N'78cc56f2-717b-45cb-b025-09c0cca68f27', CAST(N'2023-11-25T00:00:00.0000000' AS DateTime2), NULL, NULL, CAST(N'2023-11-25T12:53:40.7348907' AS DateTime2), N'travis@mailsac.com', CAST(0 AS bit), 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit)),
    (N'7d5ca2e0-5a84-47af-a31c-c80123eaab88', N'ed2da6d8-a312-489d-b7d0-253d75c6c820', N'0040e5c2-0d7f-4db8-a7e8-28c5efa6cf4f', N'78cc56f2-717b-45cb-b025-09c0cca68f27', CAST(N'2023-11-10T00:00:00.0000000' AS DateTime2), 1, 5, CAST(N'2023-11-20T11:57:25.8485341' AS DateTime2), N'travis@mailsac.com', CAST(1 AS bit), 1, NULL, CAST(1 AS bit));
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'BasketId', N'AgeGroupId', N'EthnicityId', N'GenderId', N'DateAssembled', N'Quantity', N'SafeStockLevel', N'LastUpdateDateTime', N'LastUpdateId', N'IsShoppingListItem', N'BasketNumber', N'StorageLocationId', N'Active') AND [object_id] = OBJECT_ID(N'[Baskets]'))
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name='IX_Baskets_StorageLocationId' AND object_id = OBJECT_ID(N'Baskets'))
BEGIN
	CREATE INDEX [IX_Baskets_StorageLocationId] ON [Baskets] ([StorageLocationId]);
END
GO
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name='IX_Supplies_StorageLocationId' AND object_id = OBJECT_ID(N'[Supplies]'))
BEGIN
	CREATE INDEX [IX_Supplies_StorageLocationId] ON [Supplies] ([StorageLocationId]);
END
GO
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Supplies_DonorId' AND object_id = OBJECT_ID(N'[Supplies]'))
BEGIN
    CREATE INDEX [IX_Supplies_DonorId] ON [Supplies] ([DonorId]);
END
GO
