...
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'SupplyId', N'Barcode', N'CategoryId', N'Description', N'ExcludeCategoryId', N'ExpirationDate', N'Expires', N'LastUpdateDateTime', N'LastUpdateId', N'Name', N'OptionalCategoryId', N'Price', N'PurchaseDate', N'Quantity', N'StorageLocationId', N'Active') AND [object_id] = OBJECT_ID(N'[Supplies]'))
        SET IDENTITY_INSERT [Supplies] ON;
    INSERT INTO [Supplies] ([SupplyId], [Barcode], [CategoryId], [Description], [ExcludeCategoryId], [ExpirationDate], [Expires], [LastUpdateDateTime], [LastUpdateId], [Name], [OptionalCategoryId], [Price], [PurchaseDate], [Quantity], [StorageLocationId], [Active])
    VALUES ('06f703f4-dfbf-4fd0-b0a6-5c75bc8fe17a', NULL, '2fb04be4-3b23-42eb-9534-20d767654667', N'Koala baby girls'' newborn blanket sleeper, 2 pack, take me home sleep n play pajamas (Newborn-6M)', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889740-06:00', N'travis@mailsac.com', N'Koala Baby Footed Sleeper (girl, 2 pk, NB-6M)', NULL, 10.58, '2023-11-27T15:38:38.4889740-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit)),
    ('07979a90-bab9-47cf-befd-f0b16999ee00', NULL, 'f27211ee-28cb-42a1-b487-51aa7456ccd3', N'Gerber baby boy and girl unisex terry bootie wiggle-proof socks, 4-pack, newborn, 0-6 months.', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889820-06:00', N'travis@mailsac.com', N'Baby socks (unisex, 4 pk, newborn, 0-6 months)', NULL, 4.0, '2023-11-27T15:38:38.4889820-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit)),
    ('16f0b155-8127-4eab-99e1-65473bc89952', NULL, '61da1441-6b0e-4d1a-88a2-ec632d01906d', N'Johnson''s head-to-toe gentle baby wash & shampoo, tear-free, sulfate-free & hypoallergenic wash for baby''s sensitive skin & hair, 27.1 fl. oz.', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889750-06:00', N'travis@mailsac.com', N'Gentle Baby Wash & Shampoo (tear-free, sulfate-free, hypoallergenic, 27.1 fl oz)', NULL, 11.95, '2023-11-27T15:38:38.4889750-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit)),
    ('1ec27cd4-58a3-49d3-8395-8d83536a4305', NULL, 'bf225467-4b08-4da0-a1e5-2ef0ff6e2f96', N'Desitin maximum strength baby diaper rash cream with zinc oxide, 4 oz', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889760-06:00', N'travis@mailsac.com', N'Desitin Diaper Cream (4 oz)', NULL, 7.78, '2023-11-27T15:38:38.4889750-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit)),
    ('331d83d3-04e4-41ca-9527-8ebcc1316090', NULL, 'd07d2c78-acbb-4d73-806d-1b5c67914554', N'Pampers sensitive baby wipes, 8 flip-top packs, 672 wipes', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889800-06:00', N'travis@mailsac.com', N'Pampers Baby Wipes (sensitive, 8 pk, 672 wipes)', NULL, 23.47, '2023-11-27T15:38:38.4889800-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit)),
    ('3a13f50b-b57f-44ae-ba14-f65e4e27cd54', NULL, 'ec00957f-aa3b-4c34-8554-aa2aaf10335f', N'Pampers baby-dry leakproof day & night diapers, size 2 (12-18 lb), 37 count, unisex.', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889830-06:00', N'travis@mailsac.com', N'Pampers Baby Dry Diapers Size 2 (12-18 lb), 37 Count', NULL, 9.97, '2023-11-27T15:38:38.4889820-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit)),
    ('3e2d5eee-ebfc-4a86-9c9c-18049eccaeed', NULL, 'd11d87e7-126c-4a3c-8125-b6a656d64fcc', N'NUK newborn orthodontic pacifiers, girl, 0-2 months, 2-pack.', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889720-06:00', N'travis@mailsac.com', N'Orthodontic Pacifiers (2 pk, girl, 0-2 month)', NULL, 6.77, '2023-11-27T15:38:38.4889720-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit)),
    ('5aa553c8-f564-4755-9d2a-8e5a66f884d1', NULL, 'cdfc6b7f-31fb-4bd1-a246-6b8efc241dff', N'Aveeno baby daily moisture body lotion for sensitive skin with natural colloidal oatmeal, suitable  for newborns, 18 FL oz', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889790-06:00', N'travis@mailsac.com', N'Aveeno Baby Daily Moisture Body Lotion (sensitive skin, 18 FL oz)', NULL, 11.38, '2023-11-27T15:38:38.4889790-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit)),
    ('6d59f00f-d7d8-48e3-ab36-9d96de8b09d0', NULL, '7ac8c99f-aaca-4883-ab1f-fb94fbaa9fca', N'NUK smooth flow pro anti-colic baby bottle, 5 oz, blue, 3-pack', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889800-06:00', N'travis@mailsac.com', N'Anti-colic Baby Bottles (blue, 3 pk, 5 oz)', NULL, 14.97, '2023-11-27T15:38:38.4889800-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit)),
    ('7604aea7-96b0-4096-8bbb-bbef00fdc221', NULL, 'ec00957f-aa3b-4c34-8554-aa2aaf10335f', N'Pampers swaddlers diapers, newborn (< 10 lb), 31 count, unisex', NULL, NULL, CAST(0 AS bit), '2023-11-27T15:38:38.4889810-06:00', N'travis@mailsac.com', N'Pampers Diapers (NB, 31 count)', NULL, 14.5, '2023-11-27T15:38:38.4889810-06:00', 1, '1CAE190D-DD77-4499-88CF-54C343A67B9F', CAST(1 AS bit)),
